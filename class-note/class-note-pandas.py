...
print(exframe)
print("-------e6--------")
print(exframe["Return"])
print(exframe[["Return","Cost"]])
print(exframe.loc["#1"])
print(exframe.loc[["#1","#2"]])
print("-------e6--------")
print(exframe.head(2))
print(exframe.tail(2))
print("-------e7--------")
print(exframe.sort_values(by=['Return'], ascending=False))
print(exframe.sort_index(ascending=False))
print("-------e8--------")
print(exframe.sum())
print(exframe.mean())
print(exframe.describe())